  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center px-8 py-12 md:py-20">
        <h2 className="text-section md:text-display max-w-[420px] mb-4">
          {expand(t.headline)}
        </h2>
        <p className="max-w-[420px] text-sm md:text-base text-[#222] mb-6">
          {expand(t.body)}
        </p>
        <Link
          href={config.visual.hero.cta.href}
          className="inline-flex w-fit rounded-full bg-white px-5 py-2 text-sm font-semibold hover:bg-slate hover:text-white transition"
        >
          Explore
        </Link>
      </div>
